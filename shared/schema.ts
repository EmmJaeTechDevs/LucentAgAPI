...
export type InsertUserNotificationPreferences =
...
export type InsertCropNotification = z.infer<
  typeof insertCropNotificationSchema
>;
export type DeliveryLocation = typeof deliveryLocations.$inferSelect;
export type InsertDeliveryLocation = z.infer<
  typeof insertDeliveryLocationSchema
>;
  ...
  .extend({
    ...
    harvestDate: z
      ...
      .transform((dateString, ctx) => {
        ...
        return date;
      }), // TODO: Temporarily disabled future date validation
